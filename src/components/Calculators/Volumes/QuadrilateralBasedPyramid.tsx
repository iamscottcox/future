...
import { calculateQuadrilateralBasedPyramidVolume } from "src/libs/volumes";

export const QuadrilateralBasedPyramidVolumeCalculator: FC = () => {
...
export default QuadrilateralBasedPyramidVolumeCalculator;
